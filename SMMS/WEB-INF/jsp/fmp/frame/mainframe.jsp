...
// 		document.all["TreeContainDiv"].style.width = 200;
		...
		//版本号写入
		document.getElementById("logo_version").innerHTML = "<div style='color:#ffffff;'>IDC  1.01 R1</div>";
		...
		<table id="Page_left_tree" >
			<tr id="Page_left_tree_tr">
				<td style="border:0px solid #4499ee;">
					<div id="TreeTopDiv"  onclick="moveLeftFrame('slide_l','slide_r','Page_left','slide','alt_slide',getElementById('Page_right'))"></div>
				</td>
			</tr>
			<tr id="Page_right_tree_tr" style="width:193px;">
