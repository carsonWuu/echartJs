...
function openModleDataRangeCheckPop(id,fid,tableModelId,fieldId,fieldName){
	...
	//在修改页面时调用此url，并设置过滤条件
	var url=rootPath+"/fmp/FrameCommonBiz/DoPopList?popMode=checkSinPop&tableModelId="+tableModelId+"&checkBoxMode=true&freezeCondition=and (JOBCODE!="+jobCode+")";
