...
////////对于所有操作，页面加载时要执行的代码在此完成//////////
	...
	var isFeedBack = getFieldTrueValue("ISFEEDBACK");
	if(isFeedBack == "1"){				//判断是否需要反馈是否为‘是’
		setFieldDisplay("FEEDBACKPOST", true);
	}else{
		setFieldDisplay("FEEDBACKPOST", false);
	}
}
