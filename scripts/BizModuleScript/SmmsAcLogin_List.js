...
function viewContentPath(contentPath){
	var obj = getDataMapObj('SmmsAcLogin.selectContentPathByRid&RID='+contentPath);
	if(obj.CONTENTPATH != 'null' && obj.CONTENTPATH !='' && obj.CONTENTPATH != null){
		var url = rootPath+"/SMMS/SmmsAcLoginBiz/acLoginRzjz?RID="+contentPath;
		openWindow(url);}
}