...
<li class="login_2">
	<form id="signOn" action="<%=rootPath%>/fmp/base/Login" method="POST">
		<div style="margin:80px 0px 80px 80px;">
			<TABLE align="center" width="300px" style="padding-top: 54px;padding-right: 60px;">
				<TR>
					<TD align="right">用户名： <input style="width:160px;" type="text" name="loginCode" class="login_div_input"/></TD>
				</TR>
				<TR>
				
					<TD align="right">密&nbsp;&nbsp;&nbsp;码： <input style="width:160px;" type="text" name="loginPassword" class="login_div_input" autocomplete="off" onfocus="this.type='password'"/></TD>
				</TR>
				<!-- 
				<tr>
					<td align="right" >验证码： 
