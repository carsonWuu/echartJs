...
<table  width="100%">
	...
	<tr>
	    ...
	    <td width="40%">
	    <input style="width: 96.7%;" type="text" value="" id="leftFilterText" onkeyup="filterSelectBox(this,'leftSelectBox')"/>
		...
		<td width="40%">
		<input style="width: 96.7%;" type="text" value="" id="rightFilterText" onkeyup="filterSelectBox(this,'rightSelectBox')"/>
...
<p align="center">
<input class="fbutton" type="button" name="save" value="提交" onclick="saveRoleUser();" style="width:50px;"/>
&nbsp;
...
function saveRoleUser() {
	...
	//alert(ids);
	//form0.action = "<%=rootPath%>/fmp/SUser/SaveRoleUser?ids="+ids;  
    //form0.submit();
    var userid =document.getElementById("userid").value;
    var url="<%=rootPath%>/fmp/SUser/SaveRoleUser?ids="+ids+"&userid="+userid;
