		...
		if (true) {
			...
			if (iterator1.hasNext()) {
				...
				if (!fileName.startsWith("keyword_bbs") || !fileName.endsWith(".mdf.ok")) {
					FMPLog.printLog("!fileName.startsWith(\"keyword_bbs\") || !fileName.endsWith(\".mdf.ok\")");
				} else {
					...
					if (!file.exists()) {
						...
						try {
							...
							String tableRow = "USERNAME,GROUPNAME,IP,SERV_CRC,APP_CRC,LOG_TIME,CONTENT,TITLE,URL,KEYWORDS,CONTENTPATH";
