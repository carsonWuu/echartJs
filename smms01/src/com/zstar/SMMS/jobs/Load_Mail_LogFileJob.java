		...
		if (true) {
			...
			if (iterator1.hasNext()) {
				...
				if (!fileName.startsWith("mail") || !fileName.endsWith(".mdf.ok")) {
					FMPLog.printLog("!fileName.startsWith(\"mail\") || !fileName.endsWith(\".mdf.ok\")");
				} else {
					...
					if (!file.exists()) {
						...
						try {
							...
							String tableRow = "USERNAME,GROUPNAME,IP,SERV_CRC,APP_CRC,LOG_TIME,CONTENT,TITLE,MAIL_FROM,MAIL_TO,CONTENTPATH";
