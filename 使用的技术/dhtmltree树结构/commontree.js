...
function getMenuData(sUrl){	
	...
	var ctrlLink = "<span style='color:#fff;font-size:14px;margin-left:1px;'>菜单导航</span><span style='margin-left:88px'><img src='../../images/zscrd/kuangjia/hide.png'></span>";
